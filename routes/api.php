...
Route::get('payment/status', [ApiController::class, 'checkPaymentStatus']);
...
Route::get('getClassGradesAdmin/{clsid}/{ssn}/{trm}', [ApiController::class, 'getClassGradesAdmin']);
...
Route::group([
    ...
    Route::get('getOldStaff/{schid}/{ssn}/{trm}/{clsm}/{role}', [ApiController::class, 'getOldStaff']);
    ...
    Route::get('lesson-plans/termly/{schid}/{ssn}/{trm}', [ApiController::class, 'getLessonPlansByTerm']);
    Route::get('lesson-plans/{schid}/{ssn}/{trm}/{clsm}/{sbj}', [ApiController::class, 'getLessonPlansByTerm']);
    ...
    Route::get('getStaffsEnrollmentInfoGender', [ApiController::class, 'getStaffsEnrollmentInfoGender']);
    ...
    Route::post('getLearnersStaffDetails', [ApiController::class, 'getLearnersStaffDetails']);

    Route::get('getStudentGenderDetails', [ApiController::class, 'getStudentGenderDetails']);
    Route::get('getStaffGenderDetails', [ApiController::class, 'getStaffGenderDetails']);
    ...
    Route::get('getActiveStaffByGender', [ApiController::class, 'getActiveStaffByGender']);
