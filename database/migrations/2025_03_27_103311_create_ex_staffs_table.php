...
return new class extends Migration
{
    ...
    {
        Schema::create('ex_staffs', function (Blueprint $table) {
            $table->id();
            $table->string('stid');
            $table->string('schid');
            $table->string('lname');
            ...
            $table->string('session_of_entry')->nullable();
            $table->string('term_of_entry')->nullable();
