...
public function setLessonPlan(Request $request)
{
    ...
    $data = $request->only([
        'date', 'no_of_class', 'average_age',
        'topic', 'time_from', 'time_to', 'duration', "ssn", "trm", "sbj", "schid", "clsm",
    ]);
...
public function updateLessonPlan(Request $request)
{
    ...
    $fieldsToUpdate = collect($request->only([
        "sbj", "no_of_class", "average_age", "topic", "sub_topic", "date",
        "time_from", "time_to", "duration", "learning_materials", "lesson_objectives"
...
public function updateCurriculum(Request $request)
{
   ...
   Log::info($request->all());
    ...
    $fieldsToUpdate = collect($request->only([
        "topic", "description", "teaching_aids", "sbj", "group", "url_link"
    ]))->filter(fn($value) => !is_null($value))->toArray();
